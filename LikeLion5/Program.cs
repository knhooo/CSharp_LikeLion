...
namespace LikeLion5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //bool isFinishied = false;//프로그램 종료 상태

            ////bool 러닝 = true;
            ////bool 피니시 = false;

            //Console.WriteLine(isRunning);
            //Console.WriteLine(isFinishied);
            ...
            ////닷넷 데이터 형식
            //System.Int32 number = 123; //int의 닷넷형식
            ////Int32 number = 123;
            ...
            //래퍼
            int number = 123;
            string numberAsString = number.ToString();//정수를 문자열로 반환

            //bool래퍼 형식의 메서드 활용
            bool flag = true;
            string flagAsString = flag.ToString();//논리값을 문자열로 반환
